...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_veer_eh1_time_to_threshold_comparison.py"
...
class RunVeeREH1TimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_veer_eh1_time_to_threshold_comparison_test", MODULE_PATH)
