...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_tlul_fifo_async_time_to_threshold_comparison.py"
...
class RunTlulFifoAsyncTimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_tlul_fifo_async_time_to_threshold_comparison_test", MODULE_PATH)
