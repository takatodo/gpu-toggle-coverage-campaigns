...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_xuantie_c910_cpu_baseline_validation.py"
...
class RunXuanTieC910CpuBaselineValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_xuantie_c910_cpu_baseline_validation_test", MODULE_PATH)
    ...
    def test_runner_writes_cpu_baseline_validation_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            argv = [
                "run_xuantie_c910_cpu_baseline_validation.py",
                "--mdir",
                str(mdir),
                "--template",
                str(template),
            ...
            self.assertEqual(payload["target"], "xuantie_c910")
