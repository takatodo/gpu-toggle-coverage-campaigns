...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_vortex_cpu_baseline_validation.py"
...
class RunVortexCpuBaselineValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_vortex_cpu_baseline_validation_test", MODULE_PATH)
