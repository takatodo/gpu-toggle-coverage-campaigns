...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_xiangshan_cpu_baseline_validation.py"
...
class RunXiangShanCpuBaselineValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_xiangshan_cpu_baseline_validation_test", MODULE_PATH)
