...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_xuantie_e906_time_to_threshold_comparison.py"
...
class RunXuanTieE906TimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_xuantie_e906_time_to_threshold_comparison_test", MODULE_PATH)
