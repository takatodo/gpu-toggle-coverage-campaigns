...
MODULE_PATH = SCRIPT_DIR.parent / "tools" / "set_campaign_vortex_first_surface_policy.py"
...
class SetCampaignVortexFirstSurfacePolicyTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("set_campaign_vortex_first_surface_policy_test", MODULE_PATH)
    ...
    def test_apply_profile_writes_selection_and_gate(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (profiles_dir / "vortex_candidate_only_threshold4.json").write_text(
                '{"name":"vortex_candidate_only_threshold4","step_mode":"candidate_only_threshold","design":"Vortex","candidate_threshold_value":4,"notes":"demo"}\n',
                encoding="utf-8",
            )
            ...
            payload = self.module.apply_profile(
                profile_name="vortex_candidate_only_threshold4",
            ...
            self.assertEqual(
                ...
                "vortex_candidate_only_threshold4",
            )
