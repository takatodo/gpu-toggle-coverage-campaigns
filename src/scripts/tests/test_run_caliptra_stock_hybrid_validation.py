...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_caliptra_stock_hybrid_validation.py"
...
class RunCaliptraStockHybridValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_caliptra_stock_hybrid_validation_test", MODULE_PATH)
