...
MODULE_PATH = SCRIPT_DIR.parent / "tools" / "set_campaign_veer_final_same_family.py"
...
class SetCampaignVeerFinalSameFamilyTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("set_campaign_veer_final_same_family_test", MODULE_PATH)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (profiles_dir / "veer_el2_candidate_only_threshold6.json").write_text(
                (
                    ...
                    '"design":"VeeR-EL2","candidate_threshold_value":6,"notes":"demo"}\n'
                ),
                encoding="utf-8",
            )
            ...
            payload = self.module.apply_profile(
                profile_name="veer_el2_candidate_only_threshold6",
            ...
            self.assertEqual(
                ...
                "veer_el2_candidate_only_threshold6",
            )
