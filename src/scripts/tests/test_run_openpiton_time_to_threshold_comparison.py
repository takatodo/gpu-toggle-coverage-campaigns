...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_openpiton_time_to_threshold_comparison.py"
...
class RunOpenPitonTimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_openpiton_time_to_threshold_comparison_test", MODULE_PATH)
    ...
    def test_runner_writes_hybrid_win_comparison_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(payload["target"], "openpiton")
