...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_veer_el2_time_to_threshold_comparison.py"
...
class RunVeeREL2TimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_veer_el2_time_to_threshold_comparison_test", MODULE_PATH)
    ...
    def test_runner_writes_hybrid_win_comparison_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(payload["target"], "veer_el2")
