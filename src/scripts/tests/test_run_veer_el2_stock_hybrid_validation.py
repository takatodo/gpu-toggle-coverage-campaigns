...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_veer_el2_stock_hybrid_validation.py"
...
class RunVeeREL2StockHybridValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_veer_el2_stock_hybrid_validation_test", MODULE_PATH)
    ...
    def test_runner_delegates_to_enrollment_common(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(run_mock.call_args.kwargs["slug"], "veer_el2")
