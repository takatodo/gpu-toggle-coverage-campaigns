...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_veer_eh2_stock_hybrid_validation.py"
...
class RunVeeREH2StockHybridValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_veer_eh2_stock_hybrid_validation_test", MODULE_PATH)
