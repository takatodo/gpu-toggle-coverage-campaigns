...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_veer_el2_cpu_baseline_validation.py"
...
class RunVeeREL2CpuBaselineValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_veer_el2_cpu_baseline_validation_test", MODULE_PATH)
