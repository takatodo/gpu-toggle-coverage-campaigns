...
MODULE_PATH = SCRIPT_DIR.parent / "tools" / "set_campaign_xuantie_same_family.py"
...
class SetCampaignXuantieSameFamilyTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("set_campaign_xuantie_same_family_test", MODULE_PATH)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (profiles_dir / "c906_candidate_only_threshold5.json").write_text(
                (
                    ...
                    '"design":"XuanTie-C906","candidate_threshold_value":5,"notes":"demo"}\n'
                ),
                encoding="utf-8",
            )
            ...
            payload = self.module.apply_profile(
                profile_name="c906_candidate_only_threshold5",
            ...
            self.assertEqual(
                ...
                "c906_candidate_only_threshold5",
            )
