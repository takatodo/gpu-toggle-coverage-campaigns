...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_xuantie_e906_stock_hybrid_validation.py"
...
class RunXuanTieE906StockHybridValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_xuantie_e906_stock_hybrid_validation_test", MODULE_PATH)
    ...
    def test_runner_writes_candidate_single_surface_validation_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            argv = [
                "run_xuantie_e906_stock_hybrid_validation.py",
                "--mdir",
                str(mdir),
