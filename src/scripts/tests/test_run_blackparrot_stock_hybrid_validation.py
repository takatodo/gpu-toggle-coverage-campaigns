...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_blackparrot_stock_hybrid_validation.py"
...
class RunBlackParrotStockHybridValidationTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_blackparrot_stock_hybrid_validation_test", MODULE_PATH)
