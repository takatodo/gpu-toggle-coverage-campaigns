...
MODULE_PATH = SCRIPT_DIR.parent / "runners" / "run_xbar_main_time_to_threshold_comparison.py"
...
class RunXbarMainTimeToThresholdComparisonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.module = _load_module("run_xbar_main_time_to_threshold_comparison_test", MODULE_PATH)
