...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "tlul_request_loopback_cpu_baseline_validation.json"
DEFAULT_BINARY_NAME = "tlul_request_loopback_cpu_baseline_probe"
DRIVER_SIGNAL_NAMES = {
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "caveats": [
            ...
            "This baseline reuses the frozen tlul_request_loopback reference surface and does not imply GPU-driven handoff proof.",
        ],
    }
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for tlul_request_loopback."
    )
    ...
    args.host_report_out = (
        args.host_report_out or (mdir / "tlul_request_loopback_cpu_baseline_host_report.json")
    ).resolve()
