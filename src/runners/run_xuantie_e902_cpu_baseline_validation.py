...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "xuantie_e902_cpu_baseline_validation.json"
DEFAULT_BINARY_NAME = "xuantie_e902_cpu_baseline_probe"
DEFAULT_CASE_PAT = (
...
def _build_validation_payload(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "caveats": [
            "CPU baseline measures the XuanTie-E902 host probe binary wall clock after build; compile time is excluded from v1.",
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for XuanTie-E902."
    )
    ...
    args.host_report_out = (args.host_report_out or (mdir / "xuantie_e902_cpu_baseline_host_report.json")).resolve()
