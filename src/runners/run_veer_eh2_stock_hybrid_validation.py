...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "veer_eh2_stock_hybrid_validation.json"
DEFAULT_PROGRAM_HEX = (
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator hybrid single-surface validation for VeeR-EH2."
    )
