...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "blackparrot_cpu_baseline_validation.json"
DEFAULT_PROG_MEM = (
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for BlackParrot."
    )
