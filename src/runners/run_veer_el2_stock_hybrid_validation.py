...
DEFAULT_MDIR = ROOT_DIR / "work" / "vl_ir_exp" / "veer_el2_gpu_cov_vl"
DEFAULT_TEMPLATE = ROOT_DIR / "config" / "slice_launch_templates" / "veer_el2.json"
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "veer_el2_stock_hybrid_validation.json"
DEFAULT_PROGRAM_HEX = (
    ROOT_DIR / "third_party" / "rtlmeter" / "designs" / "VeeR-EL2" / "tests" / "hello" / "program.hex"
)
DEFAULT_TARGET = "veer_el2"
DEFAULT_TOP_MODULE = "veer_el2_gpu_cov_tb"
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator hybrid single-surface validation for VeeR-EL2."
    )
