...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "xbar_main_cpu_baseline_validation.json"
DEFAULT_BINARY_NAME = "xbar_main_cpu_baseline_probe"
DRIVER_SIGNAL_NAMES = {
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "caveats": [
            ...
            "This baseline reuses the xbar_main timed-TB reference surface and does not imply design-visible GPU deltas.",
        ],
    }
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for xbar_main."
    )
    ...
    args.host_report_out = (args.host_report_out or (mdir / "xbar_main_cpu_baseline_host_report.json")).resolve()
