...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "tlul_err_cpu_baseline_validation.json"
DEFAULT_BINARY_NAME = "tlul_err_cpu_baseline_probe"
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "caveats": [
            ...
            "This baseline reuses the tlul_err timed-TB reference surface and does not imply design-visible GPU deltas.",
        ],
    }
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for tlul_err."
    )
    ...
    args.host_report_out = (
        args.host_report_out or (mdir / "tlul_err_cpu_baseline_host_report.json")
    ).resolve()
