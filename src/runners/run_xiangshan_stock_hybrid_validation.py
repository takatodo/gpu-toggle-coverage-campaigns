...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "xiangshan_stock_hybrid_validation.json"
DEFAULT_PROGRAM_BIN = (
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator hybrid single-surface validation for XiangShan."
    )
