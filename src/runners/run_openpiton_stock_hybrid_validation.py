...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "openpiton_stock_hybrid_validation.json"
DEFAULT_MEM_BIN = (
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator hybrid single-surface validation for OpenPiton."
    )
