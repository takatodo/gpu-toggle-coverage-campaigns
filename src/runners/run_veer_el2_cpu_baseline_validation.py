...
DEFAULT_JSON_OUT = ROOT_DIR / "output" / "validation" / "veer_el2_cpu_baseline_validation.json"
DEFAULT_PROGRAM_HEX = (
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Run the stock-Verilator CPU baseline validation for VeeR-EL2."
    )
