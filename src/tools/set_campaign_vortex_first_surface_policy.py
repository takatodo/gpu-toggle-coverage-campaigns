#!/usr/bin/env python3
"""
Apply a named Vortex first-surface policy profile and regenerate the active
policy gate.
"""
...
from audit_campaign_vortex_first_surface_policy_gate import build_gate


SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent.parent
DEFAULT_STEP_JSON = REPO_ROOT / "work" / "campaign_vortex_first_surface_step.json"
DEFAULT_PROFILES_DIR = REPO_ROOT / "config" / "campaign_vortex_first_surface_policy" / "profiles"
DEFAULT_SELECTION_CONFIG = REPO_ROOT / "config" / "campaign_vortex_first_surface_policy" / "selection.json"
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_vortex_first_surface_policy_gate.json"
...
def apply_profile(
    *,
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_vortex_first_surface_policy",
