#!/usr/bin/env python3
"""
Apply a named post-E906 non-OpenTitan breadth profile and regenerate the active gate.
"""
...
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_non_opentitan_breadth_gate.json"
...
def apply_profile(
    *,
    ...
    gate_payload = build_gate(
        breadth_axes_payload=_read_json(breadth_axes_json),
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_non_opentitan_breadth",
...
def main() -> int:
    ...
    payload = apply_profile(
        ...
        breadth_axes_json=args.breadth_axes_json.resolve(),
