#!/usr/bin/env python3
"""
Apply a named XuanTie breadth profile and regenerate the active gate.
"""
...
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_xuantie_breadth_gate.json"
...
def apply_profile(
    *,
    ...
    gate_payload = build_gate(
        breadth_status_payload=_read_json(breadth_status_json),
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_xuantie_breadth",
...
def main() -> int:
    ...
    payload = apply_profile(
        ...
        breadth_status_json=args.breadth_status_json.resolve(),
