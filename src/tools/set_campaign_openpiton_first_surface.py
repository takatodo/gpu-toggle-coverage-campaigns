#!/usr/bin/env python3
"""
Apply a named OpenPiton first-surface profile and regenerate the active gate.
"""
...
from audit_campaign_openpiton_first_surface_gate import build_gate


SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent.parent
DEFAULT_STEP_JSON = REPO_ROOT / "work" / "campaign_openpiton_first_surface_step.json"
DEFAULT_PROFILES_DIR = REPO_ROOT / "config" / "campaign_openpiton_first_surface" / "profiles"
DEFAULT_SELECTION_CONFIG = REPO_ROOT / "config" / "campaign_openpiton_first_surface" / "selection.json"
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_openpiton_first_surface_gate.json"
...
def apply_profile(
    *,
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_openpiton_first_surface",
