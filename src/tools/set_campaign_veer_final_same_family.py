#!/usr/bin/env python3
"""
Apply a named final VeeR same-family profile and regenerate the active gate.
"""
...
from audit_campaign_veer_final_same_family_gate import build_gate


SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent.parent
DEFAULT_STEP_JSON = REPO_ROOT / "work" / "campaign_veer_final_same_family_step.json"
DEFAULT_PROFILES_DIR = REPO_ROOT / "config" / "campaign_veer_final_same_family" / "profiles"
DEFAULT_SELECTION_CONFIG = REPO_ROOT / "config" / "campaign_veer_final_same_family" / "selection.json"
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_veer_final_same_family_gate.json"
...
def apply_profile(
    *,
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_veer_final_same_family",
