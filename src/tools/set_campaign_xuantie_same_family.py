#!/usr/bin/env python3
"""
Apply a named XuanTie same-family profile and regenerate the active gate.
"""
...
DEFAULT_GATE_JSON = REPO_ROOT / "work" / "campaign_xuantie_same_family_gate.json"
...
def apply_profile(
    *,
    ...
    return {
        "schema_version": 1,
        "scope": "set_campaign_xuantie_same_family",
